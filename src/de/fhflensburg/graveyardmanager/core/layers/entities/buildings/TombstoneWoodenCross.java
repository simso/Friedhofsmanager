 ...
 * Time: 19:09
 */
public class TombstoneWoodenCross extends Building
{

	private SpriteSheet image;

	public TombstoneWoodenCross(InGameView engine, int playerId)
	{
		super(engine, EntityData.TOMBSTONE_CROSS_WOODEN, true, playerId);
	...
	{
		g.drawImage(image.getSprite(0, 2), x, y);
	}
