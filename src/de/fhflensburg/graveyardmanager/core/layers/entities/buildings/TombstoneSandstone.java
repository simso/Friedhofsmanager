 ...
 * Time: 19:09
 */
public class TombstoneSandstone extends Building
{

	private SpriteSheet image;

	public TombstoneSandstone(InGameView engine, int playerId)
	{
		super(engine, EntityData.TOMBSTONE_SANDSTONE, true, playerId);
