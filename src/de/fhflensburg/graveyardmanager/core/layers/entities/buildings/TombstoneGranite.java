 ...
 * Time: 19:09
 */
public class TombstoneGranite extends Building
{

	private SpriteSheet image;

	public TombstoneGranite(InGameView engine, int playerId)
	{
		super(engine, EntityData.TOMBSTONE_GRANITE, true, playerId);
	...
	{
		g.drawImage(image.getSprite(0, 3), x, y);
	}
